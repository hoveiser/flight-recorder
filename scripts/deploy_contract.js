...
const contractSource = readFileSync('contracts/settlement.py', 'utf-8');

console.log('Deploying Settlement contract to studio-dev...');
...
writeFileSync('CONTRACT_ADDRESS.txt', deployedAddress);
